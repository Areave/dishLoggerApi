...
// api/auth/get
authRouter.get('/get', protect, (req: Request, res: Response) => {
    res.status(200).json({user: req.body.user});
});

// api/auth/update
authRouter.put('/update', protect, async (req: Request, res: Response) => {
...
// api/auth/delete_all
authRouter.delete('/delete_all', async (req: Request, res: Response) => {
    try {
...
// api/auth/get_all
authRouter.get('/get_all', async (req: Request, res: Response) => {
    try {
