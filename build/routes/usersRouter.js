...
exports.usersRouter.post('/auth', [
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                error_1 = _b.sent();
                console.log('from usersRouter', error_1.message);
...
// api/users/logout
exports.usersRouter.post('/logout', function (req, res) {
...
// api/users/get
exports.usersRouter.get('/get', authMiddleware_1.verifyUser, function (req, res) {
    res.status(200).json(req.body.user);
});
// api/users/get_all
exports.usersRouter.get('/get_all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users, error_3;
...
// api/users/update
exports.usersRouter.put('/update', authMiddleware_1.verifyUser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.usersRouter.delete('/delete_all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
