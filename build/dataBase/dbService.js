...
var dbConnect = function (uri) { return __awaiter(void 0, void 0, void 0, function () {
    var connect, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.log('database connected error', error_1.message);
                process.exit(1);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/, connect];
        }
    });
}); };
